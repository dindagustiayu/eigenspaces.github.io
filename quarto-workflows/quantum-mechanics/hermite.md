...
<p align ='center'>
    $$\begin{align} x(t) &= x_0 \cos (\omega t) \tag{13} \\ t(x) &=\frac{1}{\omega} \arccos (x/x_0) \tag{14} \\ |v(x(t))| &= |\dot{x} (t) | = x_0 \omega | sin (\omega t) | \tag{15} \\ |v(x)| &= x_0 \omega | \sin (\arccos(x/x_0))| \tag{16} \end{align}$$
</p>

Now this can be simplified with

<p align='center'>
    $$ \begin{align} a &= \sin (\arccos (b)) \tag{17} \\ a^2 &= \sin^2 (\arccos (b)) = 1 - \cos^2 (\arccos (b)) = 1 - b^2 \tag{18} \\ |\sin (\arccos(b)) | &= \sqrt{1- b^2} \tag{19} \end{align}$$
</p>
