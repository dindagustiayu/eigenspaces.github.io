...
If the unknown function depends on several independent variables and the equation involves partial derivatives, then we have a partial differential equation. A chemicallly reacting system without space variations can be described by a set of ordinary with time $t$ as independent variable.
...
<p align='center'>
    $$ \begin{align} A \rightarrow B \quad k_1 \\ B \rightarrow P \quad k_2 \end{align}$$
</p>

The equations governing the rate of change of A and B are
<p align='center'>
    $$\begin{align} \frac{d[A]}{dt} &= -k_1 [A] \tag{6} \\ \frac{d[B]}{dt} &= k_1[A] -k_2 [B] \tag{7} \end{align}$$
</p>

We can solve this pair of coupled equations analytically, but in our numerical solution, let $y_1 \equiv [A]$ and $y_2 \equiv [B]$:
<p align='center'>
    $$\begin{align} \frac{dy_1}{dt} &= -k_1 y_1 \tag{8} \\ \frac{dy_2}{dt} &= k_1 y_1 - k_2 y_2 \tag{9} \end{align}$$ 
</p>
...
|--------------------------|--------------------------|----------|
|1) $O_{2} + hv \longrightarrow O + O$ | Slow (creates odd oxygen)| $k_1 = 3 \times 10^{-12} \ s^{-1}$ |
...
<p align='center'>
    $$\begin{align} \frac{d[O_2]}{dt} &= -k_1 [O_2] - k_2 [O_2] [O] [M] + k_3 [O_3] + 2k_4 [O] [O_3] \tag{10} \\ \frac{d[O]}{dt} &= 2k_1[O_2] - k_2 [O_2] [O] [M] + k_3 [O_3] - k_4 [O] [O_3] \tag{11} \\ \frac{d[O_3]}{dt} &= k_2[O_2][O][M] -k_3[O_3] -k_4[O][O_3] \tag{12} \end{align}$$ 
</p>
...
<p align='center'>
    $$\frac{d[O]}{dt} =\frac{d[O_3]}{dt} = 0 \tag{13}$$
</p>

we can solve for $[O]$ and $[O_3]$

<p align='center'>
    $$\begin{align} [O] &=\frac{2k_1 [O_2] + k_3 [O_3]}{k_2 [O_2] [M]+ k_4[O_3]} \tag{14} \\ [O_3] &=\sqrt{\frac{k_1 k_2}{k_3 k_4}} [O_2] [M]^{\frac{1}{2}} \tag{15} \\ \frac{[O]}{[O_3]} &= \frac{k_3}{k_2 [O_2][M]} \tag{16} \end{align}$$
</p>
