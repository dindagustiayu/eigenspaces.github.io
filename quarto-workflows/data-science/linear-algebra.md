...
<p align='center'>
    $$\begin{align} 10\;Cr_{7}N_{66}H_{96}C_{42}O_{24} + 1176\;MnO_{4}^{-} + 2798\;H^{+} \longrightarrow 35\;Cr_{2}O_{7}^{2-} \\ + 11760\;Mn^{2+} + 420\;CO_{2} + 660\;NO_{3}^{-} + 1879\;H_{2}O \end{align}$$
</p>
...
```
<p align='left'>
  $\begin{align}s[1]^2 = e \\ s[2]^2 = e \\ s[3]^2 = e \\ s[4]^2 = e \\ s[4]^3 = e \\ s[5]^2 = e \\ s[5]^3 = e \end{align}$
</p>
